...
public class arrayadapter extends ArrayAdapter<String> {
    ...
    public arrayadapter(Context context, List<String> items, List<Integer> images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = images;
    }

    public arrayadapter(Context context, String[] items, Integer[] images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = Arrays.asList(images);
    }

    public arrayadapter(Context context, int items, int images) {
